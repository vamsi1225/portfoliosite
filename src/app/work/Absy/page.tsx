        ...
        <main className="text-foreground">
          ...
          <section className="relative w-full h-[35vh] sm:h-[40vh] lg:h-[45vh]">
            <div
              ...
              style={{ backgroundImage: `url(${AbsyCoverPhoto.src})` }}
            />
          ...
          <section className="w-full my-16 md:my-20 px-4 sm:px-6 lg:px-12">
            <div className="max-w-6xl mx-auto">
              ...
              The company needed an internal social media platform to centralize office news, announcements, achievements, and event updates. Their existing communication channels were fragmented—emails, chat groups, and bulletin boards—leading to low visibility, inconsistent communication, and poor employee engagement across teams.
              </p>
    
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">The Solution</h2>
              <p className="text-gray-400 text-sm sm:text-base mb-8">
              We developed a modern internal social media application that centralized company-wide communication in a single, intuitive platform. The solution featured a responsive Angular front-end with interactive feeds, posts, comments, and announcements, supported by a clean and familiar UI built with Angular Material and Bootstrap. To ensure controlled access, the platform included role-based permissions for admins, managers, and employees, along with real-time updates and notifications to keep teams instantly informed. The backend was built using Node.js, MySQL, and TypeORM, providing a secure, scalable architecture for managing content and user interactions across the organization.
              </p>
            </div>
          </section>
          ...
          <section className="w-full my-16 md:my-20 px-4 sm:px-6 lg:px-12 bg-slate-900 py-12 rounded-lg">
            <div className="max-w-6xl mx-auto text-white">
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>Improved cross-team communication and visibility of company updates by 35%</li>
                <li>Increased employee engagement through interactive feeds and reactions by 40%</li>
                <li>Reduced communication delays and missed announcements by 50%</li>
                <li>Delivered a user-friendly interface that boosted daily usage and adoption across departments</li>
