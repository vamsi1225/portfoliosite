  ...
  const projects = [
    {
      ...
      description: 'Logistic Regression model with preprocessing to predict if someone will donate blood based on historical data.',
      tech: 'Python · Pandas · Scikit-Learn',
      link: 'https://github.com/Shravannaikini/Blood_Donation_Prediction',
    },
    {
      title: 'Airline Delay Prediction',
      description: 'Linear Regression model trained on ~30 flight features to forecast airline delays.',
      tech: 'Python · Pandas · Scikit-Learn',
      link: 'https://github.com/Shravannaikini/Airline_Delay',
    },
    {
      title: 'Credit Card Approval Prediction',
      description: 'Logistic Regression credit scoring system to predict approval status of credit card applications.',
      tech: 'Python · Pandas · Scikit-Learn',
  ...
  return (
    <section className="w-full my-16 md:my-20 px-4 sm:px-6 lg:px-12 text-white">
      <div className="max-w-6xl mx-auto text-center mb-12">
        <h2 className="text-4xl sm:text-5xl font-bold">Analytics & Data Science</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {projects.map((proj) => (
          <div key={proj.title} className="bg-slate-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
