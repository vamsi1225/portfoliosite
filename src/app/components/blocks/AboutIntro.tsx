    ...
    <section className="py-4 md:py-12 max-w-5xl mx-auto">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg leading-relaxed">
          I was born in the humble town of <strong>Goleti, Telangana</strong>, where curiosity sparked my journey into tech. Over the years, I’ve evolved from a self-taught tinkerer into a full-stack developer driven by clean UI, fast APIs, and building things that matter.
        </p>
